...
export function Header() {
  ...
  <div className="max-w-7xl mx-auto px-6 py-4 pt-6 bg-emerald-900/40 backdrop-blur-md rounded-full border border-white/5">
    <nav className="flex items-center justify-between">
      {/* Logo */}
      <div className="text-white text-3xl font-bold">Gynger</div>

      {/* Navigation Menu */}
      <div className="hidden md:flex items-center space-x-6">
        <a href="#" className="text-white hover:text-teal-200 transition-colors">For buyers</a>
        <a href="#" className="text-white hover:text-teal-200 transition-colors">For sellers</a>
